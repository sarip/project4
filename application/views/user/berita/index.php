				...
				<div class="row">
					<div class="col-lg-8 col-12">
						<div class="blog-detail">
							...
							<img src="<?= base_url('assets/berita/') . $newsBerita->foto ?>"  class="img img-responsive img-thumbnail" style="width: 1200px; 300px;">
							<?php else: ?>
								<img src="<?= base_url('assets/berita/default.png') ?>" style="width: 100px 100px" >
							<?php endif ?>
							<div class="detail-content">
								<div class="blog-info">
									<a href="#"><i class="fa fa-calendar"></i>Tanggal Terbit : <?= $this->mylibrary->date_time($newsBerita->tanggal_terbit) ?></a>
