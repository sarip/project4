					...
					<div class="bottom-head">
						<div class="row">
							<div class="col-12">
								...
								<!-- Copyright -->
								<div class="copyright">
									<p>© Copyright 2018 <a href="https://lamuncoding.000webhostapp.com/">Lamun Coding</a>. All Rights Reserved</p>
								</div>
								<!--/ End Copyright -->
							</div>
						</div>
...
<!-- Google Maps JS -->
<script src="<?= base_url('assets/frontend/') ?>http://maps.google.com/maps/api/js?key=AIzaSyC0RqLa90WDfoJedoE3Z_Gy7a7o8PCL2jw"></script>
