          ...
          <div class="box-body">
            <div class="row">
             ...
             <div class="form-group">
              ...
              <input type="file" name="foto_portfolio" class="form-control" id="foto" placeholder="Enter foto Portfolio" required>
            ...
            <div class="form-group <?= form_error('title') ? 'has-error' : '' ?>">
              ...
              <input type="text" name="title" class="form-control" id="title" placeholder="Enter Title Portfolio"  value="<?= set_value('title') ?>" >
