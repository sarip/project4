                ...
                <?php foreach ($dataKelas as $kelas): ?>
                  <big class="text-center"><?= '<b>'.$kelas->nama_kelas .'</b> <big>'.$jurusan->nama_jurusan.'</big>'?><br></big>
                    <?php foreach ($dataPelajaran as $pelajaran): ?>
                      ...
                      <?= set_value('id_jurusan_'.$jurusan->id_jurusan.'_id_kelas_'.$kelas->id_kelas.'_id_pelajaran_'.$pelajaran->id_pelajaran) ==  $kelas->id_kelas.','.$jurusan->id_jurusan.','.$pelajaran->id_pelajaran ? 'checked' : ''?> 
